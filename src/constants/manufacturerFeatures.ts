...
export const ADDITIONAL_MANUFACTURER_FEATURES = [
  {
    title: "Innovation Validation",
    description: "Test consumer interest in new products before manufacturing",
  },
  {
    title: "Real-Time Visibility",
    description: "Track your products across the entire supply chain",
  },
  {
    title: "Crisis Early Warning",
    description: "Get alerts on supply chain disruptions before they impact you",
  },
  {
    title: "Micro-Market Penetration",
    description: "Expand into new markets with data-driven insights",
  },
  {
    title: "Granular Geographic Intelligence",
    description: "Understand demand patterns by region and locality",
  },
];
