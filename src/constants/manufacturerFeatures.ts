...
export const ADDITIONAL_MANUFACTURER_FEATURES = [
  {
    title: "Validate product ideas easily",
  ...
  // {
  //   title: "",
  //   description: "See other unique features for manufacturers • Request a demo / presentation",
  //   image: "/images/manufacturer-more.png",
  // },
