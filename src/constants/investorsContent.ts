...
export const OPPORTUNITY_SECTIONS = [
  {
    id: "overview",
    title: "Overview",
    subtitle: "See where your products are stocked.\nSee what's selling. See customer demand.\nSee competitive performance.",
  },
  {
    id: "manufacturers",
...
export const OPPORTUNITY_SLIDES = [
  {
    title: "$1.8T Market.",
    subtitle:
      "Billions in Lost Transactions annually. Africa's Retail Infrastructure Gap.",
    image: "/images/investors/opportunity-bg.jpg",
  },
];
